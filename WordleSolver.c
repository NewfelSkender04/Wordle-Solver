...
{ 
    ...
    int colorBoard[ATTEMPTS][WORDLEN];
    char guess[100];
    int attempt;
    int i;
    
    /* charger les mots */
    wordCount = load_words("words.txt", words);
    ...
    printf("Guess the %d-letter word. You have %d attempts.\n\n", WORDLEN, ATTEMPTS);/* a chaque tentative: 1)le joueur tape le mot 2)verifie que 5lettres 3)remplit lz tableau board 4) appelle la fuction (evaluate_guess) 5)affiche le board coloree 6)verifie si le mot est juste */
